...
// startup.
//
// The package is the startup/preflight boundary for KVM, swap, KSM, SMT, fixed
// Firecracker jailer account setup, physical core counting, memory, disk, and
// boot ID discovery. Downstream packages receive resolved values instead of
// repeating host identity or readiness checks.
package system
