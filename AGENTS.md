...
- API documentation updates (including Yaak request files in `apps/api-control-plane/api_doc`) must include extensive info/description content that covers purpose, auth, params, body, success/error responses, and key behavior notes.
